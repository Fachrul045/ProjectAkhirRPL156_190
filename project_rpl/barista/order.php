...
<body style="font-family: 'Poppins';">
  ...
  <div class="main-right">
    ...
    <tbody>
      ...
      $no = 1;
      $mysql = "SELECT bayar.nama, id_bayar from bayar";
      ...
      ?>
        <tr>
          ...
          <td>
          <a type="submit" href="order_process.php?id_bayar=<?=$data['id_bayar']?>" name="delete_button" class="btn btn-outline-danger">Selesai</a>
